  ...
  return (
    <div ref={ref} className="relative shrink-0">
      <button
        ...
        aria-expanded={open}
        className={`flex items-center gap-2 rounded-full border bg-white px-4 py-2.5 text-[13px] text-ink transition ${open ? "border-ink/40" : "border-line hover:border-ink/25"}`}
      >
            ...
            return (
              <li key={o.value}>
                <button
                  ...
                  className={`flex w-full items-center justify-between gap-3 px-4 py-2.5 text-left text-[13px] transition hover:bg-mist ${active ? "font-medium text-ink" : "text-sub"}`}
                >
                  {o.label}
                  {active && (
