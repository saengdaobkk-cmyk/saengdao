        ...
        {!openPrefs ? (
          ...
          <div className="flex flex-col gap-3 p-4 sm:flex-row sm:items-center sm:gap-4">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
              ...
              <button onClick={necessaryOnly} className="rounded-full bg-accent px-5 py-2 text-[13px] font-medium text-white transition hover:bg-accent/90">เฉพาะที่จำเป็น</button>
