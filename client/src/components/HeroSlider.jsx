            ...
            >
              {idx === i && (
                <div key={i} className="pointer-events-auto w-full max-w-xl animate-fadeUp">
                  {s.eyebrow && (
                    <p
                      className={`mb-3 text-[14px] font-medium tracking-tight ${s.dark ? "text-white/70" : "text-sub"}`}
                  ...
                  <h1
                    className={`whitespace-pre-line text-[45px] font-semibold leading-[1.05] tracking-tightest sm:text-6xl ${
                  ...
                  {s.subtitle && (
                    <p
                      className={`mt-5 text-[16px] leading-relaxed sm:text-lg ${s.dark ? "text-white/75" : "text-sub"}`}
                  ...
                  {s.ctaText && (
                    <a
                      ...
                      className="mt-8 inline-flex items-center rounded-full bg-accent px-6 py-2.5 text-[16px] font-medium text-white transition-transform hover:scale-[1.03] active:scale-95"
                      style={{
