...
export default function About() {
  return (
    <div className="mx-auto max-w-3xl px-5 py-16 sm:py-24">
      <p className="text-[13px] font-medium tracking-tight text-sub">เกี่ยวกับเรา</p>
      ...
      <div className="mt-12 flex flex-wrap gap-3">
        <Link to="/" className="rounded-full bg-accent px-7 py-3 text-[15px] font-medium text-white transition hover:bg-accent/90">
          เลือกซื้อหนังสือ
        </Link>
