...
export default function About() {
  return (
    <div className="mx-auto max-w-3xl px-5 py-16 sm:py-24">
      <p className="text-[16px] font-medium tracking-tight text-sub">เกี่ยวกับเรา</p>
      <h1 className="mt-2 text-4xl font-semibold tracking-tightest text-ink sm:text-5xl">
        ร้านหนังสือแสงดาว
      </h1>
      <p className="mt-6 text-[20px] leading-relaxed text-ink/80">
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-3">
        {[
          ...
          <div key={x.t} className="rounded-2xl bg-mist p-6">
            <p className="text-[18px] font-semibold text-ink">{x.t}</p>
            <p className="mt-1.5 text-[17px] leading-relaxed text-sub">{x.d}</p>
          </div>
        ))}
      </div>
      ...
      <div className="mt-14 border-t border-line pt-10">
        ...
        <p className="mt-4 text-[19px] leading-relaxed text-ink/80">
      ...
      <div className="mt-12 flex flex-wrap gap-3">
        <Link to="/" className="rounded-full bg-accent px-7 py-3 text-[18px] font-medium text-white transition hover:bg-accent/90">
          เลือกซื้อหนังสือ
        </Link>
        <Link to="/contact" className="rounded-full border border-line px-7 py-3 text-[18px] font-medium text-ink transition hover:bg-mist">
          ติดต่อเรา
        </Link>
      </div>
    </div>
