              ...
              <>
                ...
                <div className="flex items-center gap-2.5">
                  <input
                    ...
                    className="min-w-0 flex-1 rounded-full border border-line bg-white px-4 py-2 text-[13px] uppercase text-ink outline-none focus:border-ink/30"
                  />
                  <button
                    type="button"
                    onClick={applyCoupon}
                    disabled={couponBusy || !codeInput.trim()}
                    className="shrink-0 whitespace-nowrap rounded-full bg-ink px-4 py-2 text-[13px] font-medium text-white transition hover:bg-ink/90 disabled:opacity-40"
                  >
