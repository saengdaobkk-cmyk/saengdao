...
export default function Contact() {
  ...
  return (
    <div className="mx-auto max-w-page px-5 py-16 sm:py-24">
      <p className="text-[13px] font-medium tracking-tight text-sub">ติดต่อเรา</p>
      ...
      <div className="mt-12 grid gap-10 lg:grid-cols-[1fr_1.2fr]">
        ...
        <div className="rounded-2xl border border-line p-6 sm:p-8">
          <h2 className="text-[15px] font-semibold text-ink">ส่งข้อความถึงเรา</h2>
          <form onSubmit={submit} className="mt-4 space-y-4">
            ...
            <label className="block">
              <span className="mb-1.5 block text-[13px] font-medium text-ink">ข้อความ</span>
            ...
            <button type="submit" className="rounded-full bg-accent px-7 py-3 text-[15px] font-medium text-white transition hover:bg-accent/90">
              ส่งข้อความ
            </button>
...
function Info({ icon, label, value, href }) {
  const inner = (
    <>
      ...
      <span>
        <span className="block text-[12px] text-sub">{label}</span>
