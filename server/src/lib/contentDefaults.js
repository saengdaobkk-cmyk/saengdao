...
export const CONTENT_DEFAULTS = [
  ...
  { key: "about.title", section: "about", label: "หัวข้อใหญ่", value: "ร้านหนังสือแสงดาว", order: 2 },
  { key: "about.intro", section: "about", label: "ย่อหน้าแนะนำ", order: 3,
    value: "SAENGDAO คือร้านหนังสือออนไลน์ที่คัดสรรหนังสือดีมีคุณภาพมาเพื่อคุณ ตั้งแต่วรรณกรรม นิยาย ธุรกิจ พัฒนาตัวเอง ไปจนถึงหนังสือสำหรับเด็ก เราเชื่อว่าหนังสือดีเล่มหนึ่งเปลี่ยนมุมมองชีวิตได้" },
  { key: "about.feature1_title", section: "about", label: "จุดเด่น 1: หัวข้อ", value: "คัดสรรอย่างดี", order: 4 },
  { key: "about.feature1_desc", section: "about", label: "จุดเด่น 1: คำอธิบาย", value: "ทุกเล่มผ่านการเลือกโดยทีมที่รักการอ่าน", order: 5 },
  { key: "about.feature2_title", section: "about", label: "จุดเด่น 2: หัวข้อ", value: "ส่งทั่วประเทศ", order: 6 },
  { key: "about.feature2_desc", section: "about", label: "จุดเด่น 2: คำอธิบาย", value: "จัดส่งถึงบ้านคุณอย่างปลอดภัย รวดเร็ว", order: 7 },
  { key: "about.feature3_title", section: "about", label: "จุดเด่น 3: หัวข้อ", value: "ราคาเป็นมิตร", order: 8 },
  { key: "about.feature3_desc", section: "about", label: "จุดเด่น 3: คำอธิบาย", value: "โปรโมชันและส่วนลดสม่ำเสมอ", order: 9 },
  { key: "about.story_heading", section: "about", label: "หัวข้อ: เรื่องราวของเรา", value: "เรื่องราวของเรา", order: 10 },
  { key: "about.story_body", section: "about", label: "เนื้อหา: เรื่องราวของเรา (ขึ้นย่อหน้าใหม่ = เว้นบรรทัด)", order: 11,
    value: "ร้านหนังสือแสงดาวเริ่มต้นจากความรักในหนังสือ และความตั้งใจที่จะส่งต่อเรื่องราวดีๆ ให้ถึงมือผู้อ่านทุกคน เราดูแลทุกคำสั่งซื้อด้วยใจ ตั้งแต่การเลือกหนังสือ ห่ออย่างประณีต จนถึงส่งถึงมือคุณ" },
];
