...
function bookData(body) {
  return {
    ...
    preorderPrice: num(body.preorderPrice),
    preorderStart: body.preorderStart ? new Date(body.preorderStart) : null,
    preorderEnd: body.preorderEnd ? new Date(body.preorderEnd) : null,
...
function slideData(body) {
  return {
    ...
    imagePosition: ["top", "center", "bottom"].includes(body.imagePosition) ? body.imagePosition : "center",
